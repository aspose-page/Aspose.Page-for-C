...
RTTI_INFO_IMPL_HASH(4238750397u, ::CSharp::WorkingWithImages::AddTiledImageXPS, ThisTypeBaseTypesInfo);

void AddTiledImageXPS::Run()
{
    // ExStart:1
    ...
    (System::ExplicitCast<Aspose::Page::XPS::XpsModel::XpsImageBrush>(path->get_Fill()))->set_TileMode(Aspose::Page::XPS::XpsModel::XpsTileMode::Tile);
    path->get_Fill()->set_Opacity(0.5f);
    // Save resultant XPS document
    doc->Save(dataDir + u"AddTiledImage_outXPS.xps");
    // ExEnd:1
}
