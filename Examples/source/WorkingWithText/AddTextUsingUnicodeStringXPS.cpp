...
RTTI_INFO_IMPL_HASH(3210533952u, ::CSharp::WorkingWithText::AddTextUsingUnicodeStringXPS, ThisTypeBaseTypesInfo);

void AddTextUsingUnicodeStringXPS::Run()
{
    // ExStart:1
    ...
    doc->Save(dataDir + u"AddTextRTL_out.xps");
    // ExEnd:1
}
