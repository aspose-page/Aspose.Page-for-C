...
RTTI_INFO_IMPL_HASH(3879376390u, ::CSharp::WorkingWithGradient::AddHorizontalGradientXPS, ThisTypeBaseTypesInfo);

void AddHorizontalGradientXPS::Run()
{
    // ExStart:1
    ...
    doc->Save(dataDir + u"AddHorizontalGradient_outXPS.xps");
    // ExEnd:1
}
