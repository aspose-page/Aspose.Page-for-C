...
RTTI_INFO_IMPL_HASH(4042598484u, ::CSharp::WorkingWithGradient::AddVerticalGradientXPS, ThisTypeBaseTypesInfo);

void AddVerticalGradientXPS::Run()
{
    // ExStart:1
    ...
    doc->Save(dataDir + u"AddVerticalGradient_outXPS.xps");
    // ExEnd:1
}
