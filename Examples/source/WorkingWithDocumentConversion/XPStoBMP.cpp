...
RTTI_INFO_IMPL_HASH(371938352u, ::CPP::WorkingWithDocumentConversion::XPStoBMP, ThisTypeBaseTypesInfo);
...
void XPStoBMP::Run()
{
    ...
    //Outut file 
    System::String outputFileName = RunExamples::GetOutDir() + u"XPStoImage_out.bmp";
