...
RTTI_INFO_IMPL_HASH(206710026u, ::CPP::WorkingWithDocumentConversion::XPStoTIFF, ThisTypeBaseTypesInfo);
...
void XPStoTIFF::Run()
{
    ...
    //Outut file 
    System::String outputFileName = RunExamples::GetOutDir() + u"XPStoImage_out.tif";
    // Initialize XPS input stream
    {
        ...
        try
        {
            ...
            System::SharedPtr<TiffSaveOptions> options = System::MakeObject<TiffSaveOptions>();
