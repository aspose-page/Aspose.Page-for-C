...
RTTI_INFO_IMPL_HASH(206710026u, ::CSharp::WorkingWithDocumentConversion::XPStoTIFF, ThisTypeBaseTypesInfo);
...
void XPStoTIFF::Run()
{
    ...
    //Outut file 
    System::String outputFileName = dataDir + u"XPStoImage_out.tiff";
