...
RTTI_INFO_IMPL_HASH(2174645058u, ::CSharp::WorkingWithShapes::AddEllipsePS, ThisTypeBaseTypesInfo);
...
void AddEllipsePS::Run()
{
    ...
    {
        System::SharedPtr<System::IO::Stream> outPsStream = System::MakeObject<System::IO::FileStream>(dataDir + u"AddEllipse_outPS.ps", System::IO::FileMode::Create);
        ...
        try
        {
            ...
            path->AddEllipse(System::Drawing::RectangleF(250.0f, 100.0f, 150.0f, 100.0f));
            //Set paint
            ...
            path->AddEllipse(System::Drawing::RectangleF(250.0f, 300.0f, 150.0f, 100.0f));
            //Set stroke
