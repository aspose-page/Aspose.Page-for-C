...
RTTI_INFO_IMPL_HASH(3186675997u, ::CPP::WorkingWithTransparency::SetOpacityMask, ThisTypeBaseTypesInfo);

void SetOpacityMask::Run()
{
    // ExStart:1
    ...
    doc->Save(RunExamples::GetOutDir() + u"OpacityMask_out.xps");
    // ExEnd:1
}
