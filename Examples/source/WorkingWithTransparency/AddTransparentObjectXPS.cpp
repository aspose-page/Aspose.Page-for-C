...
RTTI_INFO_IMPL_HASH(4036938723u, ::CSharp::WorkingWithTransparency::AddTransparentObjectXPS, ThisTypeBaseTypesInfo);

void AddTransparentObjectXPS::Run()
{
    // ExStart:1
    ...
    doc->Save(dataDir + u"WorkingWithTransparency_out.xps");
    // ExEnd:1
}
