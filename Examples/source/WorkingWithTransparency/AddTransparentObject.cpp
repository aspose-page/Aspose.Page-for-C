...
RTTI_INFO_IMPL_HASH(3000039032u, ::CPP::WorkingWithTransparency::AddTransparentObject, ThisTypeBaseTypesInfo);

void AddTransparentObject::Run()
{
    // ExStart:1
    ...
    System::SharedPtr<XpsPath> path2 = doc->Add<System::SharedPtr<XpsPath>>(path1);
    ...
    System::SharedPtr<XpsPath> path3 = doc->Add<System::SharedPtr<XpsPath>>(path2);
    ...
    System::SharedPtr<XpsPath> path5 = doc->Add<System::SharedPtr<XpsPath>>(path4);
    ...
    System::SharedPtr<XpsPath> path7 = doc->Add<System::SharedPtr<XpsPath>>(path6->Clone());
    // (move path5 300 units lower)
    ...
    doc->Save(RunExamples::GetOutDir() + u"WorkingWithTransparency_out.xps");
    // ExEnd:1
}
