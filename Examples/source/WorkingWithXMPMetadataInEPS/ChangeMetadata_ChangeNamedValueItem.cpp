...
RTTI_INFO_IMPL_HASH(462507186u, ::CSharp::WorkingWithXMPMetadataInEPS::ChangeMetadata_ChangeNamedValueItem, ThisTypeBaseTypesInfo);
...
void ChangeMetadata_ChangeNamedValueItem::Run()
{
    ...
    
    {
        ...
        try
        {
            ...
            // Create ouput stream
            {
                System::SharedPtr<System::IO::FileStream> outPsStream = System::MakeObject<System::IO::FileStream>(dataDir + u"change_named_value_output.eps", System::IO::FileMode::Create, System::IO::FileAccess::Write);
