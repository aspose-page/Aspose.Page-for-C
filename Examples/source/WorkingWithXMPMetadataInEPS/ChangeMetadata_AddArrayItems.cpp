...
RTTI_INFO_IMPL_HASH(1670204625u, ::CSharp::WorkingWithXMPMetadataInEPS::ChangeMetadata_AddArrayItems, ThisTypeBaseTypesInfo);
...
void ChangeMetadata_AddArrayItems::Run()
{
    ...
    
    {
        ...
        try
        {
            ...
            // Create ouput stream
            {
                System::SharedPtr<System::IO::FileStream> outPsStream = System::MakeObject<System::IO::FileStream>(dataDir + u"add_array_items_output.eps", System::IO::FileMode::Create, System::IO::FileAccess::Write);
