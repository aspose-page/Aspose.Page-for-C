...
namespace Aspose { namespace Page { class IBlackList; } }
...
public:
    ...
    /// </summary>
    ASPOSE_PAGE_SHARED_API bool get_Embedded();
    /// <summary>
    /// License number was added as embedded resource.
    /// </summary>
...
public:
    ...
    /// </summary>
    Aspose::Page::EditionType get_EditionType();
    /// <summary>
...
private:
    ...
    static int32_t licIndex;
    System::ArrayPtr<System::String> mProducts;
    Aspose::Page::EditionType mEditionType;
    ...
    static System::SharedPtr<System::IO::Stream> GetEmbeddedLicense(System::String licenseName, System::SharedPtr<System::Reflection::Assembly> callingAssembly);
    /// <summary>
    ...
    /// </summary>
    static System::String GetAssemblyPath(System::SharedPtr<System::Reflection::Assembly> assembly);
    /// <summary>
    ///	The resource names can get prefixed with customer's namespace, so I do a partial name search.
    /// </summary>
    static System::SharedPtr<System::IO::Stream> GetResourceByPartialName(System::SharedPtr<System::Reflection::Assembly> assembly, System::String partialName);
