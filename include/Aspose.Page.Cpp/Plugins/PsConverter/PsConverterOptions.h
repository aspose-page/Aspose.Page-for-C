...
/// <summary>
/// Represents options for <see cref="PsConverter"></see> plugin.
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PsConverterOptions : public Aspose::Page::Plugins::IPluginOptions, public Aspose::Page::Plugins::IDataContainer, public Aspose::Page::Plugins::ISaveInstruction
{
    typedef PsConverterOptions ThisType;
    ...
    friend class Aspose::Page::Plugins::PsConverterToImageOptions;
    friend class Aspose::Page::Plugins::PsConverterToPdfOptions;
...
public:
    ...
    /// </summary>
    ASPOSE_PAGE_SHARED_API bool get_SupressErrors() const;
    /// <summary>
    /// Specifies whether errors must be suppressed or not.
    /// If true suppressed errors are added to <see cref="Exceptions"></see> list.
    /// If false the first error will terminate the program.
    /// </summary>
    ASPOSE_PAGE_SHARED_API void set_SupressErrors(bool value);
    /// <summary>
    ...
    /// Returns a list of suppressed conversion errors If <see cref="SuppressErrors"></see> is true.
    /// </summary>
    virtual ASPOSE_PAGE_SHARED_API void set_Exceptions(System::SharedPtr<System::Collections::Generic::IList<System::Exception>> value);
    /// <summary>
...
protected:
    ...
    /// <summary>
    /// Initializes new instance of the <see cref="PsConverterOptions"></see> object.
    /// </summary>
    PsConverterOptions();
    
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(PsConverterOptions, CODEPORTING_ARGS());
