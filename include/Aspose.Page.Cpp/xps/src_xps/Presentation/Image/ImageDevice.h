...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS ImageDevice : public Aspose::Page::Device, public Aspose::Page::IMultiPartitionDevice
{
...
protected:
    ...
    /// <summary>
    /// The clone constructor. Initializes new instance of <see cref="ImageDevice"></see> with existing device.
    /// </summary>
