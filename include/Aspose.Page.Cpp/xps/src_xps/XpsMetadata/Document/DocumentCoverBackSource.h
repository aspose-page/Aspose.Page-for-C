...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS DocumentCoverBackSource final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem
{
    typedef DocumentCoverBackSource ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API DocumentCoverBackSource(System::String value);
