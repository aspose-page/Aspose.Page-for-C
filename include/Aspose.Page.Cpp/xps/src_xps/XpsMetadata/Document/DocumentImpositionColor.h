...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS DocumentImpositionColor final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem
{
    typedef DocumentImpositionColor ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API DocumentImpositionColor(System::String value);
