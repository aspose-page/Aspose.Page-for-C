...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS DocumentCoverFrontSource final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem
{
    typedef DocumentCoverFrontSource ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API DocumentCoverFrontSource(System::String value);
