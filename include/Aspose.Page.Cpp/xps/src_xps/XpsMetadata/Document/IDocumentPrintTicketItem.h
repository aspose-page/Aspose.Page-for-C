...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS IDocumentPrintTicketItem : public virtual Aspose::Page::XPS::XpsMetadata::IPrintTicketItem
{
    typedef IDocumentPrintTicketItem ThisType;
