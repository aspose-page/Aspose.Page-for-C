...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS DocumentCoverFront final : public Aspose::Page::XPS::XpsMetadata::Feature, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem
{
    typedef DocumentCoverFront ThisType;
...
public:
    ...
    /// <summary>
    /// Describes the <see cref="DocumentCoverFront"></see> feature options.
    /// </summary>
    ...
    public:
        ...
        /// </summary>
        static ASPOSE_PAGE_SHARED_API System::SharedPtr<DocumentCoverFront::CoverFrontOption> NoCover;
        /// <summary>
        /// Specifies the cover indicated by "CoverFrontSource" should be printed on the back side
        /// of the cover sheet. If a <see cref="DocumentCoverFrontSource"></see> <see cref="ParameterInit"></see>
        /// element is not specified, this Option should be ignored.
        /// </summary>
        static ASPOSE_PAGE_SHARED_API System::SharedPtr<DocumentCoverFront::CoverFrontOption> PrintBack;
        /// <summary>
        /// Specifies the cover indicated by "CoverFrontSource" may be printed on either side
        /// of the cover sheet. If a <see cref="DocumentCoverFrontSource"></see> <see cref="ParameterInit"></see>
        /// element is not specified, this Option should be ignored.
        /// </summary>
        static ASPOSE_PAGE_SHARED_API System::SharedPtr<DocumentCoverFront::CoverFrontOption> PrintBoth;
        /// <summary>
        /// Specifies the cover indicated by "CoverFrontSource" should be printed on the front side
        /// of the cover sheet. If a <see cref="DocumentCoverFrontSource"></see> <see cref="ParameterInit"></see>
        /// element is not specified, this Option should be ignored.
        /// </summary>
        static ASPOSE_PAGE_SHARED_API System::SharedPtr<DocumentCoverFront::CoverFrontOption> PrintFront;
        /// <summary>
        /// Specifies a blank cover sheet should be printed.
        /// </summary>
        static ASPOSE_PAGE_SHARED_API System::SharedPtr<DocumentCoverFront::CoverFrontOption> BlankCover;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API DocumentCoverFront(const System::ArrayPtr<System::SharedPtr<DocumentCoverFront::CoverFrontOption>>& options);
