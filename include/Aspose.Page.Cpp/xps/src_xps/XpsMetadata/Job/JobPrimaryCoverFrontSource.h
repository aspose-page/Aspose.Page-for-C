...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS JobPrimaryCoverFrontSource final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem
{
    typedef JobPrimaryCoverFrontSource ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API JobPrimaryCoverFrontSource(System::String value);
