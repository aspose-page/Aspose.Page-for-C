...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageBlackGenerationProcessingGrayComponentReplacementStart final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageBlackGenerationProcessingGrayComponentReplacementStart ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageBlackGenerationProcessingGrayComponentReplacementStart(int32_t value);
