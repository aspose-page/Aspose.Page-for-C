...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageMediaSizePSWidthOffset final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageMediaSizePSWidthOffset ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageMediaSizePSWidthOffset(int32_t value);
