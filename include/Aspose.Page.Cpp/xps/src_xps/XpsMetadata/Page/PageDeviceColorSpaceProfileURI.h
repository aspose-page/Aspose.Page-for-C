...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageDeviceColorSpaceProfileURI final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageDeviceColorSpaceProfileURI ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageDeviceColorSpaceProfileURI(System::String value);
