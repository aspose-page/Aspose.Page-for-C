...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageSourceColorProfileEmbedded final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageSourceColorProfileEmbedded ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageSourceColorProfileEmbedded(System::String value);
