...
/// <summary>
/// Specifies the origin of a watermark relative to the origin of the <code>PageImageableSize</code>.
/// https://docs.microsoft.com/en-us/windows/win32/printdocs/pagewatermarkoriginheight
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageWatermarkOriginHeight final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageWatermarkOriginHeight ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageWatermarkOriginHeight(int32_t value);
