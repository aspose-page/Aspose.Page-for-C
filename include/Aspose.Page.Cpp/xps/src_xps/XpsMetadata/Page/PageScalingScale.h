...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageScalingScale final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageScalingScale ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageScalingScale(int32_t value);
