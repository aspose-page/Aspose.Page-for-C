...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageWatermarkTextFontSize final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageWatermarkTextFontSize ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageWatermarkTextFontSize(int32_t value);
