...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageWatermarkOriginWidth final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageWatermarkOriginWidth ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageWatermarkOriginWidth(int32_t value);
