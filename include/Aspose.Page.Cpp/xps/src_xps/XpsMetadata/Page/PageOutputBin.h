...
/// The <see cref="JobOutputBin"></see>, <see cref="DocumentOutputBin"></see> and <see cref="PageOutputBin"></see> keywords are
...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageOutputBin final : public Aspose::Page::XPS::XpsMetadata::OutputBin, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageOutputBin ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageOutputBin(const System::ArrayPtr<System::SharedPtr<OutputBin::IOutputBinItem>>& items);
