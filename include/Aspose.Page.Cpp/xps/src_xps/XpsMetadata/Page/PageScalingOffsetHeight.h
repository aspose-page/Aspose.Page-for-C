...
/// <summary>
/// Specifies the scaling offset in the <code>ImageableSizeWidth</code> direction for custom scaling.
/// https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingoffsetheight
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageScalingOffsetHeight final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageScalingOffsetHeight ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageScalingOffsetHeight(int32_t value);
