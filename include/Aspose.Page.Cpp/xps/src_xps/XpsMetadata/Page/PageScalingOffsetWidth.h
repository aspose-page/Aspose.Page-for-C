...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageScalingOffsetWidth final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageScalingOffsetWidth ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageScalingOffsetWidth(int32_t value);
