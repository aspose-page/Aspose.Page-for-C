...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageMediaSizePSHeightOffset final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageMediaSizePSHeightOffset ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageMediaSizePSHeightOffset(int32_t value);
