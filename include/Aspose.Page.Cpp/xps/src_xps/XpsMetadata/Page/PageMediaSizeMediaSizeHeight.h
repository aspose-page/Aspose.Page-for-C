...
/// <summary>
/// Specifies the dimension <code>MediaSizeWidth</code> direction for the Custom <code>MediaSize</code> option.
/// https://docs.microsoft.com/en-us/windows/win32/printdocs/pagemediasizemediasizeheight
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageMediaSizeMediaSizeHeight final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageMediaSizeMediaSizeHeight ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageMediaSizeMediaSizeHeight(int32_t value);
