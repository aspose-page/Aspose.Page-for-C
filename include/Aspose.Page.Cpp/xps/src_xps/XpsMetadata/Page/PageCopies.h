...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageCopies final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageCopies ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageCopies(int32_t value);
