...
/// <summary>
/// Specifies the scaling factor in the <code>ImageableSizeHeight</code> direction for custom scaling.
/// https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscaleheight
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageScalingScaleHeight final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageScalingScaleHeight ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageScalingScaleHeight(int32_t value);
