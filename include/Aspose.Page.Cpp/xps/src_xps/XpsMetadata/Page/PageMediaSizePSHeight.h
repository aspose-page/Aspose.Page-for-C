...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageMediaSizePSHeight final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageMediaSizePSHeight ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageMediaSizePSHeight(int32_t value);
