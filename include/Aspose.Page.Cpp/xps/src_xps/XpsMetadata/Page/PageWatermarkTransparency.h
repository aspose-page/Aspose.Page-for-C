...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageWatermarkTransparency final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageWatermarkTransparency ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageWatermarkTransparency(int32_t value);
