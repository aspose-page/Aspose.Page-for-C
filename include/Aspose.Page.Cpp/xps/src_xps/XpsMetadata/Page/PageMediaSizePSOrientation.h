...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageMediaSizePSOrientation final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageMediaSizePSOrientation ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageMediaSizePSOrientation(int32_t value);
