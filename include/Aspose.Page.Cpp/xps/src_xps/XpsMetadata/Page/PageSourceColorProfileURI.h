...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageSourceColorProfileURI final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageSourceColorProfileURI ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageSourceColorProfileURI(System::String value);
