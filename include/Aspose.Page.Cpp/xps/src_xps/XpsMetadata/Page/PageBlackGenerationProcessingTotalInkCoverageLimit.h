...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageBlackGenerationProcessingTotalInkCoverageLimit final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageBlackGenerationProcessingTotalInkCoverageLimit ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageBlackGenerationProcessingTotalInkCoverageLimit(int32_t value);
