...
/// <summary>
/// Specifies the scaling factor in the <code>ImageableSizeWidth</code> direction for custom scaling.
/// https://docs.microsoft.com/en-us/windows/win32/printdocs/pagescalingscalewidth
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageScalingScaleWidth final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageScalingScaleWidth ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageScalingScaleWidth(int32_t value);
