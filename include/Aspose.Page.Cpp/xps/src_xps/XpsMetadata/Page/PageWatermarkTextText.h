...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageWatermarkTextText final : public Aspose::Page::XPS::XpsMetadata::StringParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageWatermarkTextText ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageWatermarkTextText(System::String value);
