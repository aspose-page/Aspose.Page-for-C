...
/// </summary>
class ASPOSE_PAGE_SHARED_CLASS PageMediaSizePSWidth final : public Aspose::Page::XPS::XpsMetadata::IntegerParameterInit, public Aspose::Page::XPS::XpsMetadata::IJobPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IDocumentPrintTicketItem, public Aspose::Page::XPS::XpsMetadata::IPagePrintTicketItem
{
    typedef PageMediaSizePSWidth ThisType;
...
public:
    ...
    ASPOSE_PAGE_SHARED_API PageMediaSizePSWidth(int32_t value);
